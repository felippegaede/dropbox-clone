class DropBoxController {
    ...
    connectFireBase() {
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyDnpBT-4FFXJK-PjTR0LtJEcGVLIL1yFHw",
            authDomain: "dropbox-clone-5cd71.firebaseapp.com",
            databaseURL: "https://dropbox-clone-5cd71.firebaseio.com",
            projectId: "dropbox-clone-5cd71",
            storageBucket: "dropbox-clone-5cd71.appspot.com",
            messagingSenderId: "796463238501",
            appId: "1:796463238501:web:0c0c8e970048ae5933258c",
            measurementId: "G-1JC4W9X8JH"
        };
    ...
    formatTimeToHuman(duaration) {

        let seconds = parseInt((duaration / 1000) % 60);
        let minutes = parseInt((duaration / (1000 * 60)) % 60);
        let hours = parseInt((duaration / (1000 * 60 * 60)) % 24);
